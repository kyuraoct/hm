...
let dapat = (Math.floor(Math.random() * 45000))
let nomors = m.sender
  let who
  ...
  let _timers = (36000000000 - __timers) 
  let timers = clockString(_timers)
  let users = global.db.data.users
  if (new Date - global.db.data.users[m.sender].lastewe > 36000000){
  if (15000 > users[who].exp) throw 'Ga bisa di ewe ngab, dia lagi cape dan ga punya EXP\nmungkin dia lagi ga nafsu ngewe ama elu'
